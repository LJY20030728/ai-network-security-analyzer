...
; https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-lcid/a9eac961-e77d-47a6-90a5-ce1a8b0cdb9c
LanguageID=$0804
...
InfoBeforeClickLabel=如果您想继续，点击“下一步”。
WizardInfoAfter=信息
InfoAfterLabel=请在继续安装前阅读下列重要信息。
InfoAfterClickLabel=如果您想继续，点击“下一步”。
...
SelectDirBrowseLabel=点击“下一步”继续。如果您想将其它文件夹，点击“浏览”。
...
; if possible don't translate 'Compact' as 'Minimal' (I mean 'Minimal' in the prompt)
...
SelectStartMenuFolderBrowseLabel=点击“下一步”继续。如果您想将其它文件夹，点击“浏览”。
...
ErrorRegCreateKey=创建注册表项时出错：%n%1
ErrorRegWriteKey=写入注册表项时出错：%n%1
...
ErrorRestartingComputer=安装程序不能启动电脑，请手动重启。
...
AssocingFileExtension=正在将 %2 文件扩展名与 %1 建立关联关联...
